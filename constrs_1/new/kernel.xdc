...
set_property PACKAGE_PIN U15 [get_ports {light[9]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {light[9]}]
set_property PACKAGE_PIN U14 [get_ports {light[8]}]
...
set_property PACKAGE_PIN V13 [get_ports {light[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {light[6]}]
set_property PACKAGE_PIN V3 [get_ports {light[5]}]
